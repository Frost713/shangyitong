...
import com.mxchen.shangyitong.gatewayimpl.database.mongo.BaseMongoEntity;
...
@Document("Hospital")
public class HospitalDO extends BaseMongoEntity {
	...
	private BookingRuleDO bookingRule;
